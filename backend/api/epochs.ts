...
/**
 * GET /api/epochs - Get list of epochs
 * Query params:
 *   - limit: number of epochs to return (default 20)
...
export default async function handler(
    ...
    try {
        ...
        const response = await fetch(`${OCTRA_RPC_URL}/epochs?limit=${limit}&offset=${offset}`, {
            method: 'GET',
            headers: {
        ...
        error(res, ErrorCodes.INTERNAL_ERROR, `Failed to fetch epochs: ${message}`, 500);
    }
}
